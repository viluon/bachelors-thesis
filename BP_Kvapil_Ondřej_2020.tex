...
\abstractEN{Lazy evaluation is a potentially }
\abstractCS{V několika větách shrňte obsah a přínos této práce v českém jazyce.}
\placeForDeclarationOfAuthenticity{Prague}
\keywordsCS{Haskell, Dynamické trasování, Líné vyhodnocování, Plugin moduly
kompilátorů, Generické programování} \keywordsEN{Haskell, Dynamic tracing, Lazy
evaluation, Compiler plugins, Generic programming}
