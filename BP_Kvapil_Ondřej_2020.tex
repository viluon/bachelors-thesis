...
\abstractCS{
	...
	Nabízí se otázka: \emph{Vyplatí se lenost?} K zodpovězení této otázky
	musíme porozumět tomu, jak je lenost využívána v praxi. K tomuto účelu jsme
	vyvinuli nástroj pro dynamickou analýzu použitelný k trasování
	vyhodnocování funkčních parametrů. Je implementován jako zásuvný modul
