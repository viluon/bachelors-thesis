...
\hsCode{tcg\_binds ::~LHsBinds GhcTc} is interesting to us. The type
...
\begin{enumerate}
	...
	\item \hsIdent{incrementCC} wraps the right-hand sides of functions with a
		\hsCode{let} binding, introducing a call counter variable into their
		scope.
\end{enumerate}
